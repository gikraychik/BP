...
<?php Action::run('theme_pre_content'); ?><div id="navigation" class="navbar navbar-default navbar-static-top">
...
<?php } else {
// send page title
?><title><?php echo Site::name() . ' - ' . Site::title(); ?></title><?php
// send content
